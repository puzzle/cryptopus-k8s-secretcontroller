...
func NewForConfig(c *rest.Config) (*CryptopussecretcontrollerV1alpha1Client, error) {
	...
	return &CryptopussecretcontrollerV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new CryptopussecretcontrollerV1alpha1Client for the given config and
...
func New(c rest.Interface) *CryptopussecretcontrollerV1alpha1Client {
	return &CryptopussecretcontrollerV1alpha1Client{c}
}
