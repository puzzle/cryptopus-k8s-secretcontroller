...
type SharedInformerFactory interface {
	...
	Cryptopussecretcontroller() cryptopussecretcontroller.Interface
}

func (f *sharedInformerFactory) Cryptopussecretcontroller() cryptopussecretcontroller.Interface {
	return cryptopussecretcontroller.New(f, f.namespace, f.tweakListOptions)
}
